...
export function BirdWatchingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="relative h-[500px] bg-gradient-to-br from-green-900 via-emerald-800 to-[#D91680]">
        <div
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            {quickNavItems.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="text-sm font-medium text-gray-700 hover:text-[#D91680] transition-colors"
              >
                {item.label}
              </a>
            ))}
          ...
          <div className="lg:col-span-2">
              ...
              {northernLocations.map((location, index) => (
                <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden mb-8">
                  <div className="relative h-64">
                    ...
                    {index === 0 && (
                      <div className="absolute top-4 left-4 bg-[#D91680] text-white px-3 py-1 rounded-full shadow-md">
                  ...
                  <div className="p-8">
                    ...
                    <div className="mb-6">
                      <h4 className="text-lg font-semibold text-gray-900 mb-3 flex items-center">
                        <Bird className="w-5 h-5 text-[#D91680] mr-2" />
                        Target Species
                      </h4>
            ...
            <section id="practical" className="mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                    <Clock className="w-6 h-6 text-[#D91680] mr-2" />
                    Best Times to Bird
                  </h3>
                  <ul className="space-y-3">
                    <li className="flex items-start text-sm">
          ...
          <aside className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                <Clock className="w-5 h-5 text-[#D91680] mr-2" />
                Quick Facts
              </h3>

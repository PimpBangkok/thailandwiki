          ...
          <div className="lg:col-span-2 space-y-12">
              ...
              <div className="space-y-8">
                {beaches.map((beach, index) => (
                  <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-xl transition-shadow">
                    {beach.isHighlight && (
                      <div className="bg-gradient-to-r from-[#2B5D8C] to-[#ff1493] text-white px-4 py-2 text-sm font-semibold">
                        Must-See Highlight
                      </div>
                    )}
            ...
            <section id="getting-there">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow">
                  <div className="bg-gradient-to-br from-pink-100 to-[#2B5D8C] w-16 h-16 rounded-full flex items-center justify-center mb-4">
                    <Anchor className="w-8 h-8 text-[#2B5D8C]" />
                  </div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">From Phuket</h3>
                  <div className="space-y-2 text-sm text-gray-700">
                    <p className="font-semibold text-[#2B5D8C]">Ferry: 2 hours</p>
            ...
            <section id="how-long">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-6 rounded-lg shadow-lg border-t-4 border-[#2B5D8C] transform md:scale-105">
                  <div className="text-center mb-4">
                    <div className="inline-block bg-[#2B5D8C] text-white px-3 py-1 rounded-full text-xs font-semibold mb-2">
                      RECOMMENDED
                    </div>
                    <div className="text-3xl font-bold text-[#2B5D8C] mb-2">2-3 Days</div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <div className="space-y-3 text-sm">
                    <div>
                      <span className="font-semibold text-[#2B5D8C]">From Phuket:</span>

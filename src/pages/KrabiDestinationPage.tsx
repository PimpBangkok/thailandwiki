          ...
          <div className="lg:col-span-2 space-y-12">
                      ...
                      <div className="md:w-3/5 p-6">
                        ...
                        {island.name === 'Koh Phi Phi' && (
                          <div className="mt-4 pt-4 border-t border-gray-200">
                            <a
                              href="/destinations"
                              className="text-[#D91680] hover:text-[#D91680] font-medium text-sm inline-flex items-center"
                            >
            ...
            <section id="accommodation">
              ...
              <div className="mt-8 text-center">
                <a
                  href="/accommodation"
                  className="inline-flex items-center px-6 py-3 bg-[#D91680] text-white rounded-lg hover:bg-[#D91680] transition-colors font-medium"
                >
                ...
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex items-center space-x-3 mb-4">
                    <div className="bg-pink-100 p-3 rounded-lg">
                      <Anchor className="w-6 h-6 text-[#D91680]" />
                    </div>
            ...
            <section id="itineraries">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 rounded-lg overflow-hidden shadow-md">
                  <div className="bg-[#D91680] text-white p-4">
                  ...
                  <div className="p-6 space-y-4">
                    <div className="flex items-start space-x-4">
                      <div className="bg-[#D91680] text-white rounded-full w-8 h-8 flex items-center justify-center font-semibold flex-shrink-0">
                        1
                      </div>
                      <div>
                        <span className="font-semibold text-[#D91680]">Arrive in Krabi</span>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <span className="font-semibold text-[#D91680]">4 Islands Tour or Hong Island Tour</span>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <span className="font-semibold text-[#D91680]">Railay Beach</span>
              ...
              <div className="mt-6 text-center">
                <a
                  href="/itineraries"
                  className="text-[#D91680] hover:text-[#D91680] font-medium inline-flex items-center"
                >

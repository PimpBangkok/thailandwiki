              ...
              <nav className="space-y-2">
                {quickNavItems.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
                    className="block text-sm text-gray-600 hover:text-[#D91680] transition-colors"
                  >
                    {item.label}
                  </a>
                ))}
          ...
          <main className="lg:col-span-9 space-y-16">
            <section id="overview">
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-pink-100 p-6 rounded-lg text-center">
                  <DollarSign className="w-10 h-10 text-[#D91680] mx-auto mb-3" />
                  <div className="text-2xl font-bold text-[#D91680]">$300</div>
            ...
            <section id="when-to-go" className="mt-16">
              ...
              <div className="bg-gradient-to-br from-pink-50 to-cyan-50 rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-[#D91680] mb-3">Best Season: November - April</h4>
                  <ul className="space-y-2 text-sm text-gray-700">
                    <li className="flex items-start">
                ...
                <div className="bg-[#D91680] text-white p-4 rounded-lg text-sm font-semibold">
            ...
            <section id="costs" className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <h4 className="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                    <Ship className="w-5 h-5 mr-2 text-[#D91680]" />
                    Day Trips
                  </h4>
                  <div className="space-y-3 text-sm mb-4">
                    <div className="flex justify-between pb-2 border-b border-gray-200">
            ...
            <section id="diving-vs-snorkeling" className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-green-50 rounded-lg shadow-lg p-8 border-t-4 border-[#D91680]">
                  <div className="flex items-center mb-6">
                    <div className="bg-[#D91680] rounded-full p-3 mr-4">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                      <CheckCircle2 className="w-5 h-5 text-[#D91680] mr-3 mt-0.5 flex-shrink-0" />
                      <div>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-lg shadow-lg p-8 mb-12">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white rounded-lg p-5 shadow-md border-l-4 border-amber-500">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700 mt-1">Choose <strong className="text-[#D91680]">SNORKELING</strong>, not enough time for certification</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-5 shadow-md border-l-4 border-green-500">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700 mt-1">Choose <strong className="text-[#D91680]">SNORKELING</strong>, costs $30-60 versus $300+ for diving</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-5 shadow-md border-l-4 border-[#D91680]">
                    <div className="flex items-start">
                      <ArrowRight className="w-5 h-5 text-[#D91680] mr-3 mt-1 flex-shrink-0" />
                      <div>
                        <p className="font-semibold text-gray-900">If scared of deep water:</p>
                        <p className="text-sm text-gray-700 mt-1">Choose <strong className="text-[#D91680]">SNORKELING</strong>, stay near surface with easy exit</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-5 shadow-md border-l-4 border-pink-500">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-700 mt-1">Choose <strong className="text-[#D91680]">SNORKELING</strong>, everyone participates together</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="bg-white/20 backdrop-blur rounded-lg p-4">
                        ...
                        <div className="bg-[#D91680] rounded p-3 mt-2 text-center">
              ...
              <div className="bg-white rounded-lg shadow-lg p-8 mt-12 mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-gradient-to-br from-pink-50 to-green-50 rounded-lg p-6 border-2 border-pink-200">
                    ...
                    <div className="bg-[#D91680] text-white p-4 rounded-lg text-center">

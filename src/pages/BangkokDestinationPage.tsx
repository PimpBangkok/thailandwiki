    ...
    <>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="bg-gradient-to-br from-pink-50 to-cyan-50 border-l-4 border-[#D91680] p-8 md:p-10 rounded-lg shadow-sm">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex flex-col">
                <dt className="text-sm font-semibold text-[#D91680] uppercase tracking-wider mb-2">
                  Best For
                </dt>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            <div className="bg-white border border-gray-200 p-8 rounded-lg hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center mb-4">
                <svg className="w-6 h-6 text-[#D91680]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="p-8">
                ...
                <a href="#" className="text-[#D91680] font-medium hover:text-[#D91680] uppercase text-sm tracking-wider">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <div className="p-6">
                ...
                <a href="#" className="text-[#D91680] font-medium hover:text-[#D91680] uppercase text-sm tracking-wider inline-flex items-center">
      ...
      <section className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-xl transition-all duration-300">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-[#D91680]">
              ...
              <a href="#" className="inline-flex items-center text-[#D91680] font-medium hover:text-[#D91680] uppercase text-sm tracking-wider">
          ...
          <div className="text-center">
            <a href="#" className="inline-block bg-[#D91680] text-white px-8 py-4 rounded-lg hover:bg-[#D91680] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-6">
                <div className="w-12 h-12 bg-[#D91680] rounded-full flex items-center justify-center text-2xl shadow-md mr-4 flex-shrink-0 font-bold text-white">
                  C
                </div>
                <div>
                  <h3 className="text-2xl font-semibold text-gray-900 uppercase tracking-wide">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-xl transition-all duration-300">
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-[#D91680] rounded-full flex items-center justify-center mr-3 flex-shrink-0 font-bold text-white text-lg">
                  3D
                </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              <a href="#" className="flex items-start p-4 rounded-lg hover:bg-gray-50 transition-colors group">
                <span className="text-[#D91680] mr-3 font-bold">•</span>
                <span className="font-light text-gray-700 group-hover:text-[#D91680]">Bangkok for Food Lovers</span>
              </a>
              <a href="#" className="flex items-start p-4 rounded-lg hover:bg-gray-50 transition-colors group">
                <span className="text-[#D91680] mr-3 font-bold">•</span>
                <span className="font-light text-gray-700 group-hover:text-[#D91680]">Bangkok Temple Trail</span>
              </a>
              <a href="#" className="flex items-start p-4 rounded-lg hover:bg-gray-50 transition-colors group">
                <span className="text-[#D91680] mr-3 font-bold">•</span>
                <span className="font-light text-gray-700 group-hover:text-[#D91680]">Bangkok Nightlife Guide</span>
              </a>
              <a href="#" className="flex items-start p-4 rounded-lg hover:bg-gray-50 transition-colors group">
                <span className="text-[#D91680] mr-3 font-bold">•</span>
                <span className="font-light text-gray-700 group-hover:text-[#D91680]">Bangkok Shopping Marathon</span>
              </a>
              <a href="#" className="flex items-start p-4 rounded-lg hover:bg-gray-50 transition-colors group">
                <span className="text-[#D91680] mr-3 font-bold">•</span>
                <span className="font-light text-gray-700 group-hover:text-[#D91680]">Bangkok Off the Beaten Path</span>
              </a>
              <a href="#" className="flex items-start p-4 rounded-lg hover:bg-gray-50 transition-colors group">
                <span className="text-[#D91680] mr-3 font-bold">•</span>
                <span className="font-light text-gray-700 group-hover:text-[#D91680]">Bangkok Photography Tour</span>
              </a>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="flex items-start p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all duration-300">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#D91680] font-medium mb-2">200 articles</p>
                <p className="text-gray-700 font-light">
            ...
            <div className="flex items-start p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all duration-300">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#D91680] font-medium mb-2">150 articles</p>
                <p className="text-gray-700 font-light">
            ...
            <div className="flex items-start p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all duration-300">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#D91680] font-medium mb-2">100 articles</p>
                <p className="text-gray-700 font-light">
            ...
            <div className="flex items-start p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all duration-300">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#D91680] font-medium mb-2">80 articles</p>
                <p className="text-gray-700 font-light">
            ...
            <div className="flex items-start p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all duration-300">
              <div className="flex-1">
                ...
                <p className="text-sm text-[#D91680] font-medium mb-2">67 articles</p>
                <p className="text-gray-700 font-light">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <div className="bg-white border border-gray-200 rounded-lg p-8">
              ...
              <ul className="space-y-4 text-gray-700">
                <li className="flex items-start">
                  <span className="text-[#D91680] mr-2 font-bold">•</span>
                  <div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
            <a href="#" className="bg-white border border-gray-200 rounded-lg p-8 text-center hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-lg font-semibold text-gray-900 uppercase tracking-wide group-hover:text-[#D91680]">
                Budget & Costs
              </h3>
            </a>
      ...
      <section className="py-16 md:py-24 bg-pink-50">
        <div className="max-w-[800px] mx-auto px-6 lg:px-12">
          <div className="bg-white border-2 border-pink-200 rounded-lg p-12 text-center shadow-lg">
            <div className="w-16 h-16 bg-[#D91680] rounded-full flex items-center justify-center mx-auto mb-6 font-bold text-white text-3xl">
              ?
            </div>
            ...
            <a href="/contact" className="inline-block bg-[#D91680] text-white px-10 py-4 rounded-lg hover:bg-[#D91680] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
              Ask a Question →
            </a>
          </div>
        </div>

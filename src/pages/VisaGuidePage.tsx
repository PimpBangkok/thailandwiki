        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="border-t border-gray-200 pt-12">
              ...
              <div className="bg-pink-50 border-l-4 border-[#D91680] p-6 rounded-r-lg mb-8">
                <h3 className="text-xl font-semibold text-[#D91680] mb-3 mt-0">Extensions</h3>
                <p className="text-[#D91680] mb-2">
                  <strong>Can extend once for 30 more days</strong> at any immigration office in Thailand.
                </p>
                <div className="flex items-center gap-4 text-sm text-[#D91680] mt-3">
            ...
            <div className="border-t border-gray-200 pt-12">
              ...
              <div className="bg-gray-50 rounded-xl p-8 mb-8">
                ...
                <ul className="space-y-2 text-gray-700 text-lg mb-0">
                  <li className="flex items-start gap-2">
                    <Check className="w-5 h-5 text-[#D91680] flex-shrink-0 mt-1" />
                ...
                <div className="space-y-4">
                  <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <div className="flex items-start gap-4">
                      <div className="bg-pink-100 text-[#D91680] rounded-full w-8 h-8 flex items-center justify-center font-bold flex-shrink-0">
                        1
                      </div>
                      <div>
                        ...
                        <div className="bg-gray-50 p-3 rounded text-sm text-gray-600">
                          <strong>Recommended:</strong> E-visa is faster and more convenient. Check if available for your country at <a href="https://www.thaievisa.go.th" target="_blank" rel="noopener noreferrer" className="text-[#D91680] hover:underline">thaievisa.go.th</a>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-pink-50 border-l-4 border-[#D91680] p-6 rounded-r-lg">
                <h3 className="text-xl font-semibold text-[#D91680] mb-3 mt-0">Extensions</h3>
                <p className="text-[#D91680] mb-0">
            ...
            <div className="border-t border-gray-200 pt-12">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <div className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-[#D91680] transition-all">
                  <h3 className="text-xl font-semibold text-gray-900 mb-3">Visa on Arrival</h3>
                  <div className="space-y-2 text-gray-700 mb-4">
                    <p className="font-semibold text-[#D91680]">15 Days</p>
                ...
                <div className="bg-gradient-to-br from-pink-50 to-blue-50 border-2 border-pink-200 rounded-xl p-6">
                  ...
                  <div className="space-y-2 text-gray-700 mb-4">
                    <p className="font-semibold text-[#D91680]">Valid 6 Months</p>
                ...
                <div className="bg-white border-2 border-gray-200 rounded-xl p-6 hover:border-[#D91680] transition-all">
                  ...
                  <div className="space-y-2 text-gray-700 mb-4">
                    <p className="font-semibold text-[#D91680]">Updated 2024</p>
              ...
              <div className="bg-gradient-to-br from-gray-50 to-pink-50 rounded-xl p-8 mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                      <MapPin className="w-5 h-5 text-[#D91680]" />
                      Locations
                    </h4>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
                        <span className="text-[#D91680] font-bold">-</span>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-3 flex items-center gap-2">
                      <FileText className="w-5 h-5 text-[#D91680]" />
                      Requirements
                    </h4>
                    <ul className="space-y-2 text-gray-700">
                      <li className="flex items-start gap-2">
                ...
                <div className="grid md:grid-cols-3 gap-4 mt-6 pt-6 border-t border-pink-200">
                  <div className="flex items-center gap-3">
                    <DollarSign className="w-8 h-8 text-[#D91680] flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-center gap-3">
                    <Clock className="w-8 h-8 text-[#D91680] flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-center gap-3">
                    <Calendar className="w-8 h-8 text-[#D91680] flex-shrink-0" />
                    <div>
            ...
            <div className="border-t border-gray-200 pt-12">
              ...
              <div className="space-y-6">
                <div className="bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:border-[#D91680] transition-all">
                  ...
                  <div className="p-6">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <p className="text-gray-700 mb-4">Up to <strong className="text-[#D91680]">10 years</strong> with multiple entries</p>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2 text-gray-700 text-sm mb-4">
                          <li className="flex items-start gap-2">
                            <Check className="w-4 h-4 text-[#D91680] flex-shrink-0" />
            ...
            <div className="border-t border-gray-200 pt-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <a
                  ...
                  className="block bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg hover:border-[#D91680] transition-all group"
                >
                  <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-[#D91680] transition-colors">
            ...
            <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-[#D91680] text-white rounded-2xl p-12 text-center mt-12 relative overflow-hidden">

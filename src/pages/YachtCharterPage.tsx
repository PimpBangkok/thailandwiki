...
export function YachtCharterPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="relative h-[500px] bg-gradient-to-br from-blue-900 via-cyan-800 to-[#D91680]">
        <div
        ...
        <div className="grid lg:grid-cols-3 gap-8 mt-8">
          <div className="lg:col-span-2 space-y-8">
                ...
                {yachtTypes.map((yacht, index) => (
                  <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div className="relative h-64">
                      ...
                      />
                      <div className="absolute top-4 right-4 bg-[#D91680] text-white px-3 py-1 rounded-full shadow-md">
                  ...
                  <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div className="p-8">
                      ...
                      {destination.reachable && (
                        <div className="mb-6">
                          <h4 className="text-lg font-semibold text-gray-900 mb-3 flex items-center">
                            <Navigation className="w-5 h-5 text-[#D91680] mr-2" />
                  ...
                  <div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
                    <div className="relative h-48">
                      <img
                        ...
                        className="w-full h-full object-cover"
                      />
                      <div className="absolute top-4 right-4 bg-gradient-to-r from-[#D91680] to-pink-600 text-white px-4 py-2 rounded-full shadow-md">
            ...
            <section id="seasons">
              ...
              <div className="mt-8 bg-gradient-to-br from-[#D91680] to-cyan-600 text-white rounded-lg shadow-xl p-6">
            ...
            <section id="packing">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                    <Camera className="w-6 h-6 text-[#D91680] mr-2" />
                    Gear & Accessories
                  </h3>
            ...
            <section id="insider-tips">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                    <Waves className="w-6 h-6 text-[#D91680] mr-2" />
                    Seasickness Prevention
                  </h3>
                  <ul className="space-y-2">
                    {insiderTips.seasickness.map((tip, i) => (
                      <li key={i} className="flex items-start text-sm text-gray-700">
                        <CheckCircle2 className="w-4 h-4 text-[#D91680] mr-2 mt-0.5 flex-shrink-0" />
                        <span>{tip}</span>
                      </li>
                    ))}
                  </ul>
            ...
            <section id="corporate">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="bg-white rounded-lg shadow-md p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4 flex items-center">
                    <Gift className="w-6 h-6 text-[#D91680] mr-2" />
                ...
                {faqs.map((faq, index) => (
                  <div key={index} className="bg-white rounded-lg shadow-md p-6">
                    <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-start">
                      <HelpCircle className="w-5 h-5 text-[#D91680] mr-2 mt-0.5 flex-shrink-0" />
          ...
          <aside className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 flex items-center">
                <Calendar className="w-5 h-5 text-[#D91680] mr-2" />
                Quick Reference
              </h3>

      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <div className="bg-gradient-to-r from-pink-50 to-blue-50 border-l-4 border-[#D91680] p-8 mb-12 rounded-r-lg">
            ...
            <div className="border-t border-gray-200 pt-12">
              <div className="flex items-center gap-3 mb-8">
                <div className="bg-pink-100 p-3 rounded-lg">
                  <DollarSign className="w-8 h-8 text-[#D91680]" />
                </div>
                ...
                <div className="bg-gradient-to-br from-pink-50 to-blue-50 border-2 border-pink-200 rounded-2xl overflow-hidden">
                  ...
                  <div className="p-8">
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div className="bg-white rounded-xl p-6 border border-pink-200">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <div>
                            <h4 className="font-semibold text-gray-900">Accommodation</h4>
                            <p className="text-[#D91680] font-semibold">$30-60/night</p>
                          </div>
                        </div>
                        <ul className="space-y-2 text-sm text-gray-700">
                          <li className="flex items-center gap-2">
                      ...
                      <div className="bg-white rounded-xl p-6 border border-pink-200">
                        <div className="flex items-center gap-3 mb-4">
                          <div className="bg-pink-100 p-3 rounded-lg">
                            <Utensils className="w-6 h-6 text-[#D91680]" />
                          </div>
                          <div>
                            <h4 className="font-semibold text-gray-900">Food</h4>
                            <p className="text-[#D91680] font-semibold">$25-40/day</p>
                          </div>
                        </div>
                        <ul className="space-y-2 text-sm text-gray-700">
                          <li className="flex items-center gap-2">
                      ...
                      <div className="bg-white rounded-xl p-6 border border-pink-200">
                        <div className="flex items-center gap-3 mb-4">
                          <div className="bg-pink-100 p-3 rounded-lg">
                            <Car className="w-6 h-6 text-[#D91680]" />
                          </div>
                          <div>
                            <h4 className="font-semibold text-gray-900">Transportation</h4>
                            <p className="text-[#D91680] font-semibold">$10-20/day</p>
                          </div>
                        </div>
                        <ul className="space-y-2 text-sm text-gray-700">
                          <li className="flex items-center gap-2">
                      ...
                      <div className="bg-white rounded-xl p-6 border border-pink-200">
                        <div className="flex items-center gap-3 mb-4">
                          <div className="bg-pink-100 p-3 rounded-lg">
                            <Activity className="w-6 h-6 text-[#D91680]" />
                          </div>
                          <div>
                            <h4 className="font-semibold text-gray-900">Activities</h4>
                            <p className="text-[#D91680] font-semibold">$20-40/day</p>
                          </div>
                        </div>
                        <ul className="space-y-2 text-sm text-gray-700">
                          <li className="flex items-center gap-2">
                    ...
                    <div className="bg-pink-100 rounded-xl p-6 text-center">
                      <p className="text-lg font-semibold text-[#D91680]">
                        <span className="text-3xl font-bold">$80-150</span> per day
                      </p>
                      <p className="text-sm text-[#D91680] mt-2">Most popular choice for comfortable travel with good value</p>
                    </div>
                  </div>
                </div>
            ...
            <div className="border-t border-gray-200 pt-12 mt-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all">
                  ...
                  <div className="space-y-3 text-gray-700">
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      ...
                      <span className="font-semibold text-[#D91680]">$1-3</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Local restaurant meal</span>
                      <span className="font-semibold text-[#D91680]">$3-5</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Mid-range restaurant</span>
                      <span className="font-semibold text-[#D91680]">$8-15</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Fine dining</span>
                      <span className="font-semibold text-[#D91680]">$30-100+</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Beer (local bar)</span>
                      <span className="font-semibold text-[#D91680]">$2-3</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Coffee (local shop)</span>
                      <span className="font-semibold text-[#D91680]">$1-2</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>Water bottle (7-Eleven)</span>
                      <span className="font-semibold text-[#D91680]">$0.30-0.50</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all">
                  ...
                  <div className="space-y-3 text-gray-700">
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      ...
                      <span className="font-semibold text-[#D91680]">$0.50-1.50</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                    ...
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      ...
                      <span className="font-semibold text-[#D91680]">$3-8</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Tuk-tuk (negotiated)</span>
                      <span className="font-semibold text-[#D91680]">$3-10</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Motorbike rental (day)</span>
                      <span className="font-semibold text-[#D91680]">$5-10</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Car rental (day)</span>
                      <span className="font-semibold text-[#D91680]">$30-80</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span>Airport rail link (Bangkok)</span>
                      <span className="font-semibold text-[#D91680]">$1.50</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all">
                  ...
                  <div className="space-y-3 text-gray-700">
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      ...
                      <span className="font-semibold text-[#D91680]">Free</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Grand Palace</span>
                      <span className="font-semibold text-[#D91680]">$15</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>National park entry</span>
                      <span className="font-semibold text-[#D91680]">$6-10</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                    ...
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      ...
                      <span className="font-semibold text-[#D91680]">$30-50</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-[#D91680]">$60-100</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6 hover:shadow-lg transition-all">
                  <h3 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
                    <ShoppingBag className="w-6 h-6 text-[#D91680]" />
                    Shopping & Miscellaneous
                  </h3>
                  <div className="space-y-3 text-gray-700">
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>SIM card (tourist)</span>
                      <span className="font-semibold text-[#D91680]">$10-20</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                    ...
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                      <span>Haircut</span>
                      <span className="font-semibold text-[#D91680]">$5-15</span>
                    </div>
                    <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-[#D91680]">$5-8</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="border-t border-gray-200 pt-12 mt-12">
              <div className="flex items-center gap-3 mb-8">
                <div className="bg-pink-100 p-3 rounded-lg">
                  <Lightbulb className="w-8 h-8 text-[#D91680]" />
                </div>
                <h2 className="text-4xl md:text-5xl font-light text-gray-900 uppercase tracking-wide m-0">
                  Money-Saving Tips
                </h2>
            ...
            <div className="border-t border-gray-200 pt-12 mt-12">
              <div className="flex items-center gap-3 mb-8">
                <div className="bg-pink-100 p-3 rounded-lg">
                  <Calendar className="w-8 h-8 text-[#D91680]" />
                </div>
                <h2 className="text-4xl md:text-5xl font-light text-gray-900 uppercase tracking-wide m-0">
                  Sample Trip Costs
                </h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-gradient-to-br from-pink-50 to-blue-50 border-2 border-pink-200 rounded-2xl p-8">
                  <div className="flex items-center gap-3 mb-6">
                    <div className="bg-pink-100 p-3 rounded-lg">
                      <MapPin className="w-10 h-10 text-[#D91680]" />
                    </div>
                    <div>
                      <h3 className="text-2xl font-semibold text-gray-900">Mid-Range Travel</h3>
                      <p className="text-[#D91680] font-medium">$80-150 per day</p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="bg-white rounded-xl p-4 border border-pink-200">
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-semibold text-gray-900">1 Week in Thailand</span>
                        <span className="text-2xl font-bold text-[#D91680]">$600-1,000</span>
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-4 border border-pink-200">
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-semibold text-gray-900">2 Weeks in Thailand</span>
                        <span className="text-2xl font-bold text-[#D91680]">$1,200-2,200</span>
                      </div>
                    ...
                    <div className="bg-white rounded-xl p-4 border border-pink-200">
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-semibold text-gray-900">1 Month in Thailand</span>
                        <span className="text-2xl font-bold text-[#D91680]">$2,500-4,000</span>
                      </div>
            ...
            <div className="border-t border-gray-200 pt-12 mt-12">
              ...
              <div className="bg-gradient-to-r from-pink-50 to-blue-50 border border-pink-200 rounded-xl p-8 mt-6">
                <h4 className="text-xl font-semibold text-gray-900 mb-4 flex items-center gap-2">
                  <Lightbulb className="w-6 h-6 text-[#D91680]" />
                  Best Cards for Thailand Travel
                </h4>
                <div className="grid md:grid-cols-3 gap-4 text-gray-700">
                  <div>
                    <p className="font-semibold text-[#D91680] mb-1">No Foreign Transaction Fees</p>
                    <p className="text-sm mb-0">Saves 3% on every purchase</p>
                  </div>
                  <div>
                    <p className="font-semibold text-[#D91680] mb-1">ATM Fee Reimbursement</p>
                    <p className="text-sm mb-0">Some banks refund Thai ATM fees</p>
                  </div>
                  <div>
                    <p className="font-semibold text-[#D91680] mb-1">Travel Rewards</p>
            ...
            <div className="bg-gradient-to-br from-gray-900 via-[#D91680] to-blue-900 text-white rounded-2xl p-12 text-center mt-12 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <span className="text-[#D91680]">→</span>
                </button>
              </div>
            </div>
          </div>

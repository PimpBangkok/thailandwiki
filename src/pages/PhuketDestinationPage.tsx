...
export default function PhuketDestinationPage() {
  ...
  return (
    <>
      <div className="relative h-[70vh] min-h-[500px] bg-gradient-to-b from-[#2B5D8C] to-[#2B5D8C]">
        <div
      ...
      <div className="sticky top-16 bg-white border-b border-gray-200 shadow-sm z-40">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <nav className="flex overflow-x-auto scrollbar-hide">
            <a href="#overview" className="px-4 py-4 text-sm font-medium text-gray-700 hover:text-[#2B5D8C] hover:border-b-2 hover:border-[#2B5D8C] whitespace-nowrap uppercase tracking-wide transition-colors">
              Overview
            </a>
            <a href="#beaches" className="px-4 py-4 text-sm font-medium text-gray-700 hover:text-[#2B5D8C] hover:border-b-2 hover:border-[#2B5D8C] whitespace-nowrap uppercase tracking-wide transition-colors">
              Beaches
            </a>
            <a href="#things-to-do" className="px-4 py-4 text-sm font-medium text-gray-700 hover:text-[#2B5D8C] hover:border-b-2 hover:border-[#2B5D8C] whitespace-nowrap uppercase tracking-wide transition-colors">
              Things to Do
            </a>
            <a href="#where-to-stay" className="px-4 py-4 text-sm font-medium text-gray-700 hover:text-[#2B5D8C] hover:border-b-2 hover:border-[#2B5D8C] whitespace-nowrap uppercase tracking-wide transition-colors">
              Where to Stay
            </a>
            <a href="#food" className="px-4 py-4 text-sm font-medium text-gray-700 hover:text-[#2B5D8C] hover:border-b-2 hover:border-[#2B5D8C] whitespace-nowrap uppercase tracking-wide transition-colors">
              Food & Dining
            </a>
            <a href="#island-hopping" className="px-4 py-4 text-sm font-medium text-gray-700 hover:text-[#2B5D8C] hover:border-b-2 hover:border-[#2B5D8C] whitespace-nowrap uppercase tracking-wide transition-colors">
              Island Hopping
            </a>
            <a href="#itineraries" className="px-4 py-4 text-sm font-medium text-gray-700 hover:text-[#2B5D8C] hover:border-b-2 hover:border-[#2B5D8C] whitespace-nowrap uppercase tracking-wide transition-colors">
              Itineraries
            </a>
            <a href="#practical" className="px-4 py-4 text-sm font-medium text-gray-700 hover:text-[#2B5D8C] hover:border-b-2 hover:border-[#2B5D8C] whitespace-nowrap uppercase tracking-wide transition-colors">
              Practical Info
            </a>
          </nav>
        </div>
      ...
      <section id="overview" className="py-16 md:py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-pink-50 border-l-4 border-[#2B5D8C] p-8 rounded-r-lg shadow-sm">
            ...
            <div className="mt-12 text-center">
              <a href="#beaches" className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-8 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
      ...
      <section id="beaches" className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-4xl mx-auto space-y-6 mb-12">
            <div className="bg-white border-l-4 border-[#2B5D8C] p-6 rounded-r-lg shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="text-center">
            <a href="#all-beaches" className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-8 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
              <div className="relative h-56 overflow-hidden">
                ...
                />
                <div className="absolute top-4 left-4 bg-[#2B5D8C] text-white p-3 rounded-full shadow-lg">
              ...
              <div className="p-6">
                ...
                <a href="#beaches" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                  <span>Explore all Phuket beaches</span>
            ...
            <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <a href="#island-hopping" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <a href="#water-activities" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <a href="#nightlife" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group">
              ...
              <div className="p-6">
                ...
                <a href="#attractions" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
      ...
      <section id="where-to-stay" className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[#2B5D8C] font-semibold text-lg">$15-300/night</p>
                </div>
                <div>
              ...
              <a href="#patong-hotels" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Price Range:</p>
                  <p className="text-[#2B5D8C] font-semibold text-lg">$20-200/night</p>
                </div>
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Highlights:</p>
              ...
              <a href="#kata-hotels" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Price Range:</p>
                  <p className="text-[#2B5D8C] font-semibold text-lg">$30-250/night</p>
                </div>
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Highlights:</p>
              ...
              <a href="#kamala-hotels" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Price Range:</p>
                  <p className="text-[#2B5D8C] font-semibold text-lg">$100-800/night</p>
                </div>
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Highlights:</p>
              ...
              <a href="#bangtao-hotels" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Price Range:</p>
                  <p className="text-[#2B5D8C] font-semibold text-lg">$25-150/night</p>
                </div>
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Highlights:</p>
              ...
              <a href="#south-phuket" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div>
                  <p className="text-sm font-semibold text-gray-900 uppercase tracking-wide mb-1">Price Range:</p>
                  <p className="text-[#2B5D8C] font-semibold text-lg">$150-1,000+/night</p>
                </div>
              </div>

              <a href="#phuket-villas" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
          ...
          <div className="text-center">
            <a href="#all-accommodation" className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-8 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
      ...
      <section id="food" className="py-16 md:py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="text-center">
            <a href="#all-food-guides" className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-8 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#3-day-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#5-day-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#7-day-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#weekend-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#family-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#budget-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#luxury-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#couples-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#watersports-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#nightlife-guide" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#diving-itinerary" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              ...
              <a href="#island-hopping-guide" className="inline-flex items-center text-[#2B5D8C] hover:text-[#2B5D8C] font-medium uppercase text-sm tracking-wider group">
                <span>Read Full Itinerary</span>
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
          ...
          <div className="text-center">
            <a href="#all-itineraries" className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-8 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
      ...
      <section id="island-hopping" className="py-16 md:py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-4xl mx-auto space-y-8 mb-12">
            <div className="bg-white rounded-lg shadow-md p-8 hover:shadow-lg transition-shadow">
              <div className="flex items-start space-x-4">
                <div className="bg-[#2B5D8C] text-white p-4 rounded-full flex-shrink-0">
          ...
          <div className="text-center">
            <a href="#island-guide" className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-8 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
      ...
      <section id="practical" className="py-16 md:py-24 bg-gray-50">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-[#2B5D8C] hover:shadow-lg transition-all duration-300">
              <div className="flex items-start space-x-4 mb-6">
                <div className="bg-[#2B5D8C] text-white p-3 rounded-full flex-shrink-0">
          ...
          <div className="text-center">
            <a href="#practical-guide" className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-8 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          <div className="max-w-3xl mx-auto bg-white border-2 border-[#2B5D8C] rounded-2xl p-12 shadow-xl text-center">
            <div className="flex justify-center mb-6">
              <div className="bg-[#2B5D8C] text-white p-4 rounded-full">

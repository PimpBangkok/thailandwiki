...
export default function FoodDiningPage() {
  ...
  const collections = [
    ...
    { title: 'Best Street Food Cities', icon: Store, color: 'bg-[#2B5D8C]' },
    ...
    <>
      ...
      <section className="relative h-[70vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-6 max-w-5xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light mb-8 uppercase tracking-[3px] leading-tight">
            Thai Food
            <br />
            <span className="text-[#F4A261]">& Dining Guide</span>
          </h1>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-lg">
            <div className="flex items-center gap-2">
              <Store className="w-5 h-5 text-[#F4A261]" />
              <span>2,500+ Restaurant Guides</span>
            </div>
            <div className="w-1 h-1 rounded-full bg-white/50"></div>
            <div className="flex items-center gap-2">
              <ChefHat className="w-5 h-5 text-[#F4A261]" />
              ...
              <div id="must-try-dishes" className="mb-20 scroll-mt-24">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-12 h-12 rounded-full bg-[#F4A261]/10 flex items-center justify-center flex-shrink-0">
                    <UtensilsCrossed className="w-6 h-6 text-[#F4A261]" />
                  </div>
                  <div>
                ...
                <div className="text-center">
                  <Link
                    to="/food-dining"
                    className="inline-flex items-center gap-2 px-8 py-4 bg-[#F4A261] text-white hover:bg-[#2B5D8C] transition-colors rounded-lg font-semibold shadow-lg hover:shadow-xl uppercase tracking-[1.5px]"
                  >
              ...
              <div id="street-food" className="mb-20 scroll-mt-24">
                <div className="flex items-center gap-4 mb-8">
                  <div className="w-12 h-12 rounded-full bg-[#2B5D8C]/10 flex items-center justify-center flex-shrink-0">
                    <Store className="w-6 h-6 text-[#2B5D8C]" />
                  </div>
                  <div>
                    <h2 className="text-3xl md:text-4xl font-light uppercase tracking-[2px] text-[#252525]">
                      Street Food
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {streetFoodByType.map((type, index) => {
                      ...
                      return (
                        ...
                        >
                          <div className="w-12 h-12 rounded-full bg-[#2B5D8C]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#2B5D8C]/20 transition-colors">
                ...
                <div className="text-center">
                  <Link
                    to="/food-dining"
                    className="inline-flex items-center gap-2 px-8 py-4 bg-[#2B5D8C] text-white hover:bg-[#2B5D8C] transition-colors rounded-lg font-semibold shadow-lg hover:shadow-xl uppercase tracking-[1.5px]"
                  >
                    Explore Street Food
                    <ArrowRight className="w-5 h-5" />
                  </Link>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="relative">
                          ...
                          <h4 className="text-xl font-bold text-white mb-2 group-hover:text-[#F4A261] transition-colors">
                            {collection.title}
                          </h4>
      ...
      <section className="py-32 bg-gradient-to-br from-[#252525] via-[#2a2a2a] to-[#1f1f1f] text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#2B5D8C] rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="max-w-[1700px] mx-auto px-6 lg:px-12 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-5xl md:text-6xl font-light mb-8 uppercase tracking-[2px] leading-tight">
              Questions About
              <br />
              <span className="text-[#F4A261]">Thai Food?</span>
            </h2>

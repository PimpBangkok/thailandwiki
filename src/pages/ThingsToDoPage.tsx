      ...
      <section className="relative h-[60vh] min-h-[500px] bg-gray-900">
        ...
        <div className="relative h-full flex items-center justify-center text-center px-6">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-[#D91680] uppercase tracking-widest font-medium">
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition-shadow duration-300">
              <div className="grid md:grid-cols-2">
                <div className="relative h-80 md:h-full overflow-hidden">
                  ...
                  />
                  <div className="absolute top-6 left-6 bg-[#D91680] text-white p-4 rounded-full shadow-xl">
                ...
                <div className="p-8 md:p-10 flex flex-col justify-center">
                  ...
                  <p className="text-sm text-[#D91680] uppercase tracking-wider mb-6 font-medium">
                    500 guides
                  </p>
                  ...
                  <div>
                    <a
                      ...
                      className="inline-flex items-center space-x-2 bg-[#D91680] text-white px-8 py-4 rounded-lg hover:bg-[#D91680] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl"
                    >
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-[#D91680] hover:shadow-xl transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                <div className="bg-[#D91680] text-white p-3 rounded-lg">
                  <MapPin className="w-6 h-6" />
                </div>
                <div>
                  <h3 className="text-2xl font-light text-gray-900 uppercase tracking-wide">Bangkok</h3>
                  <p className="text-sm text-[#D91680] font-medium">800 guides</p>
                </div>
              </div>
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-[#D91680] hover:shadow-xl transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#D91680] font-medium">600 guides</p>
                </div>
              </div>
              <p className="text-gray-600 font-light mb-6 leading-relaxed">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-[#D91680] hover:shadow-xl transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#D91680] font-medium">450 guides</p>
                </div>
              </div>
              <p className="text-gray-600 font-light mb-6 leading-relaxed">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-[#D91680] hover:shadow-xl transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#D91680] font-medium">300 guides</p>
                </div>
              </div>
              <p className="text-gray-600 font-light mb-6 leading-relaxed">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-[#D91680] hover:shadow-xl transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#D91680] font-medium">250 guides</p>
                </div>
              </div>
              <p className="text-gray-600 font-light mb-6 leading-relaxed">
            ...
            <div className="bg-white border-2 border-gray-200 rounded-xl p-8 hover:border-[#D91680] hover:shadow-xl transition-all duration-300">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#D91680] font-medium">200 guides</p>
                </div>
              </div>
              <p className="text-gray-600 font-light mb-6 leading-relaxed">
          ...
          <div className="text-center">
            <a
              ...
              className="inline-flex items-center space-x-2 bg-[#D91680] text-white px-10 py-4 rounded-lg hover:bg-[#D91680] transition-colors font-medium uppercase text-sm tracking-wider shadow-lg hover:shadow-xl"
            >

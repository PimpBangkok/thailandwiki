        ...
        <div className="grid lg:grid-cols-[1fr_300px] gap-8">
          <div className="space-y-16">
            ...
            <section id="bangkok-hotels">
              <h2 className="text-3xl sm:text-4xl font-light text-[#2D2D2D] mb-6 uppercase tracking-[2px] border-b-2 border-amber-600 pb-3">
            ...
            <section id="samui-hotels">
              <h2 className="text-3xl sm:text-4xl font-light text-[#2D2D2D] mb-6 uppercase tracking-[2px] border-b-2 border-emerald-600 pb-3">
          ...
          <aside className="space-y-6">
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-24">
              ...
              <nav className="space-y-2 text-sm">
                ...
                <a href="#phuket-hotels" className="block text-gray-700 hover:text-[#D91680] transition-colors">
                  → Phuket Hotels
                </a>
                <a href="#samui-hotels" className="block text-gray-700 hover:text-[#D91680] transition-colors">
                  → Koh Samui Hotels
                </a>
                <a href="#chiang-mai-hotels" className="block text-gray-700 hover:text-[#D91680] transition-colors">
                  → Chiang Mai Hotels
                </a>
                <a href="#destination-selector" className="block text-gray-700 hover:text-[#D91680] transition-colors">

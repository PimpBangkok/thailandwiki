      ...
      <div className="relative h-[60vh] min-h-[500px] bg-gray-900">
        ...
        <div className="relative h-full flex items-center justify-center text-center px-6">
          <div className="max-w-4xl">
            ...
            <div className="inline-block bg-[#2B5D8C] text-white px-8 py-3 rounded-lg text-lg font-medium">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-12">
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#2B5D8C] hover:shadow-2xl transition-all duration-300">
                <div className="relative h-64 bg-gray-200">
                  ...
                  />
                  <div className="absolute top-6 left-6 bg-[#2B5D8C] text-white p-3 rounded-lg shadow-lg">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[#2B5D8C] font-medium text-lg">1,200 guides</span>
                  </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#2B5D8C] hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[#2B5D8C] font-medium text-lg">800 guides</span>
                  </div>
                  <p className="text-xl text-gray-700 font-light mb-6">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#2B5D8C] hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[#2B5D8C] font-medium text-lg">450 guides</span>
                  </div>
                  <p className="text-xl text-gray-700 font-light mb-6">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#2B5D8C] hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[#2B5D8C] font-medium text-lg">350 guides</span>
                  </div>
                  <p className="text-xl text-gray-700 font-light mb-6">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#2B5D8C] hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[#2B5D8C] font-medium text-lg">200 guides</span>
                  </div>
                  <p className="text-xl text-gray-700 font-light mb-6">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#2B5D8C] hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[#2B5D8C] font-medium text-lg">100 guides</span>
                  </div>
                  <p className="text-xl text-gray-700 font-light mb-6">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#2B5D8C] hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[#2B5D8C] font-medium text-lg">700 guides</span>
                  </div>
                  <p className="text-xl text-gray-700 font-light mb-6">
                  ...
                  <div className="bg-pink-50 border-l-4 border-[#2B5D8C] p-4 mb-6">
                    <div className="flex items-start space-x-3">
                      <div className="w-8 h-8 bg-[#2B5D8C] rounded-full flex items-center justify-center flex-shrink-0 text-white font-bold">
                        !
                      </div>
                      <div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden hover:border-[#2B5D8C] hover:shadow-2xl transition-all duration-300">
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="text-[#2B5D8C] font-medium text-lg">300 guides</span>
                  </div>
                  <p className="text-xl text-gray-700 font-light mb-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6 max-w-7xl">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-200">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[#2B5D8C] font-medium text-sm">1,200 guides</span>
                </div>
                <div className="mb-4">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-200">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[#2B5D8C] font-medium text-sm">800 guides</span>
                </div>
                <div className="mb-4">
                  <p className="text-sm text-gray-600 font-medium mb-2">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-200">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[#2B5D8C] font-medium text-sm">400 guides</span>
                </div>
                <div className="mb-4">
                  <p className="text-sm text-gray-600 font-medium mb-2">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-200">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[#2B5D8C] font-medium text-sm">350 guides</span>
                </div>
                <div className="mb-4">
                  <p className="text-sm text-gray-600 font-medium mb-2">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-200">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[#2B5D8C] font-medium text-sm">300 guides</span>
                </div>
                <div className="mb-4">
                  <p className="text-sm text-gray-600 font-medium mb-2">
            ...
            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-gray-200">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-[#2B5D8C] font-medium text-sm">250 guides</span>
                </div>
                <div className="mb-4">
                  <p className="text-sm text-gray-600 font-medium mb-2">
          ...
          <div className="text-center mt-12">
            <a
              href="#"
              className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-8 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium text-lg shadow-lg hover:shadow-xl"
            >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <div className="bg-gray-50 rounded-xl p-8 border border-gray-200">
              <div className="flex items-center space-x-3 mb-6">
                <BookOpen className="w-6 h-6 text-[#2B5D8C]" />
                <h3 className="text-2xl font-light text-gray-900">Planning & Choosing</h3>
              </div>
              <ul className="space-y-4">
                <li>
                  <a href="#" className="flex items-center justify-between text-gray-700 hover:text-[#2B5D8C] transition-colors group">
            ...
            <div className="bg-gray-50 rounded-xl p-8 border border-gray-200">
              <div className="flex items-center space-x-3 mb-6">
                <FileText className="w-6 h-6 text-[#2B5D8C]" />
          ...
          <div className="text-center">
            <a
              href="#"
              className="inline-flex items-center space-x-2 text-[#2B5D8C] hover:text-[#2B5D8C] font-medium text-lg transition-colors"
            >
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="#" className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Star className="w-6 h-6 text-[#2B5D8C]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-light text-gray-900 mb-2 group-hover:text-[#2B5D8C] transition-colors">
                    Best Luxury Hotels in Thailand
                  </h3>
                  <p className="text-sm text-gray-600 font-light mb-3">
                    Top 50 five-star properties
                  </p>
                  <div className="flex items-center text-[#2B5D8C] font-medium text-sm">
            ...
            <a href="#" className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Backpack className="w-6 h-6 text-[#2B5D8C]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-light text-gray-900 mb-2 group-hover:text-[#2B5D8C] transition-colors">
                    Best Budget Hotels
            ...
            <a href="#" className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Users className="w-6 h-6 text-[#2B5D8C]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-light text-gray-900 mb-2 group-hover:text-[#2B5D8C] transition-colors">
                    Best Family Resorts
            ...
            <a href="#" className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Heart className="w-6 h-6 text-[#2B5D8C]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-light text-gray-900 mb-2 group-hover:text-[#2B5D8C] transition-colors">
            ...
            <a href="#" className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Palmtree className="w-6 h-6 text-[#2B5D8C]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-light text-gray-900 mb-2 group-hover:text-[#2B5D8C] transition-colors">
                    Best Beach Resorts
            ...
            <a href="#" className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Waves className="w-6 h-6 text-[#2B5D8C]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-light text-gray-900 mb-2 group-hover:text-[#2B5D8C] transition-colors">
            ...
            <a href="#" className="bg-white rounded-xl p-6 border border-gray-200 hover:shadow-xl transition-all duration-300 group">
              <div className="flex items-start space-x-4">
                <div className="w-12 h-12 bg-pink-100 rounded-lg flex items-center justify-center flex-shrink-0">
                  <Leaf className="w-6 h-6 text-[#2B5D8C]" />
                </div>
                <div className="flex-1">
                  <h3 className="text-xl font-light text-gray-900 mb-2 group-hover:text-[#2B5D8C] transition-colors">
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                <button className="px-6 py-3 bg-white border-2 border-gray-300 rounded-full text-gray-700 hover:border-[#2B5D8C] hover:text-[#2B5D8C] transition-colors font-light">
                  Budget ($5-40)
                </button>
                <button className="px-6 py-3 bg-white border-2 border-gray-300 rounded-full text-gray-700 hover:border-[#2B5D8C] hover:text-[#2B5D8C] transition-colors font-light">
                  Mid-Range ($40-150)
        ...
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center border border-gray-200">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-pink-100 rounded-full mb-6">
              <MessageCircle className="w-8 h-8 text-[#2B5D8C]" />
            </div>
            ...
            <a
              href="/contact"
              className="inline-flex items-center space-x-2 bg-[#2B5D8C] text-white px-10 py-4 rounded-lg hover:bg-[#2B5D8C] transition-colors font-medium text-lg shadow-lg hover:shadow-xl"
            >

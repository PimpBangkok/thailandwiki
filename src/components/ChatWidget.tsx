      ...
      <div className="fixed bottom-5 right-5 z-[9999]">
        {!isExpanded ? (
          <button
            ...
            data-chat-button
            className="group relative w-[60px] h-[60px] bg-gradient-to-br from-[#D91680] to-[#D91680] hover:from-[#D91680] hover:to-[#D91680] text-white rounded-full shadow-2xl hover:scale-110 transition-all duration-300 flex items-center justify-center animate-pulse hover:animate-none"
          ...
          >
            <div className="bg-gradient-to-r from-[#D91680] via-[#D91680] to-[#D91680] text-white p-4 flex items-center justify-between shadow-lg">
                  ...
                  <div className="bg-white rounded-2xl rounded-tl-none p-5 shadow-md border border-gray-100">
                    ...
                    <ul className="space-y-2 text-gray-700 text-sm">
                      <li className="flex items-start">
                        <span className="mr-2 text-[#D91680]">-</span>
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      {initialSuggestions.map((question, index) => (
                        <button
                          ...
                          className="w-full text-left bg-white hover:bg-gradient-to-r hover:from-pink-50 hover:to-pink-100 border border-gray-200 hover:border-[#D91680] rounded-xl p-3 text-sm text-gray-700 hover:text-[#D91680] transition-all shadow-sm hover:shadow-md group"
                        >
                      ...
                      >
                        <div
                          className={`max-w-[85%] rounded-2xl p-4 shadow-md ${
                            msg.isUser
                              ? 'bg-gradient-to-r from-[#D91680] to-[#D91680] text-white rounded-br-none'
                            ...
                            <div className="flex flex-wrap gap-2">
                              {msg.suggestions.map((suggestion, idx) => (
                                <button
                                  ...
                                  className="px-3 py-1.5 bg-white hover:bg-pink-50 border border-gray-300 hover:border-[#D91680] rounded-full text-xs text-gray-700 hover:text-[#D91680] transition-all shadow-sm hover:shadow"
                                >
                                  {suggestion}
                                </button>
                              ))}
                    ...
                    <div className="flex justify-start animate-in fade-in duration-300">
                      <div className="bg-white text-gray-900 rounded-2xl rounded-tl-none p-4 shadow-md border border-gray-100">
                        <div className="flex space-x-1.5">
                          <div className="w-2 h-2 bg-[#D91680] rounded-full animate-bounce"></div>
                          <div className="w-2 h-2 bg-[#D91680] rounded-full animate-bounce delay-100"></div>
                          <div className="w-2 h-2 bg-[#D91680] rounded-full animate-bounce delay-200"></div>
                        </div>
                      </div>
                    </div>
                  )}
            ...
            <form onSubmit={handleSubmit} className="p-4 bg-white border-t border-gray-200 shadow-lg">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="flex-1 px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#D91680] focus:border-transparent text-sm bg-gray-50 focus:bg-white transition-colors"
                />
                <button
                  type="submit"
                  disabled={!message.trim()}
                  className="w-11 h-11 bg-gradient-to-r from-[#D91680] to-[#D91680] hover:from-[#D91680] hover:to-[#D91680] disabled:from-gray-300 disabled:to-gray-300 disabled:cursor-not-allowed text-white rounded-full flex items-center justify-center transition-all shadow-md hover:shadow-lg hover:scale-105 disabled:hover:scale-100"

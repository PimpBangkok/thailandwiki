...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-slate-800 to-slate-900 text-white">
      <div className="bg-[#d7007f] py-12 sm:py-14 md:py-16">
        <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto mb-4 px-4">
              ...
              <button
                type="submit"
                className="px-6 py-3 sm:px-8 sm:py-4 bg-slate-900 hover:bg-[#d7007f] text-white rounded-full font-light uppercase tracking-wider transition-all duration-300 flex items-center justify-center gap-2 min-h-[44px] text-sm sm:text-base"
              >
                Subscribe
      ...
      <div className="max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-12 pt-12 sm:pt-14 md:pt-16 pb-8 sm:pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 md:gap-12 mb-12 sm:mb-14 md:mb-16">
          <div className="lg:col-span-1 sm:col-span-2">
            <h3 className="text-xl sm:text-2xl font-light mb-2 sm:mb-3 uppercase tracking-[2px] text-[#d7007f]">
              ThailandWiki
            </h3>
            ...
            <div className="flex gap-3 flex-wrap">
              <a href="#" className="w-11 h-11 sm:w-10 sm:h-10 bg-white/5 hover:bg-[#d7007f] rounded-full flex items-center justify-center transition-all duration-300" aria-label="Facebook">
                <Facebook className="w-5 h-5 sm:w-4 sm:h-4" />
              </a>
              <a href="#" className="w-11 h-11 sm:w-10 sm:h-10 bg-white/5 hover:bg-[#d7007f] rounded-full flex items-center justify-center transition-all duration-300" aria-label="Instagram">
                <Instagram className="w-5 h-5 sm:w-4 sm:h-4" />
              </a>
              <a href="#" className="w-11 h-11 sm:w-10 sm:h-10 bg-white/5 hover:bg-[#d7007f] rounded-full flex items-center justify-center transition-all duration-300" aria-label="Twitter">
                <Twitter className="w-5 h-5 sm:w-4 sm:h-4" />
              </a>
              <a href="#" className="w-11 h-11 sm:w-10 sm:h-10 bg-white/5 hover:bg-[#d7007f] rounded-full flex items-center justify-center transition-all duration-300" aria-label="Pinterest">
              ...
              <a href="#" className="w-11 h-11 sm:w-10 sm:h-10 bg-white/5 hover:bg-[#d7007f] rounded-full flex items-center justify-center transition-all duration-300" aria-label="YouTube">
          ...
          <div>
            <h4 className="text-xs sm:text-sm font-semibold mb-4 sm:mb-6 text-[#d7007f] uppercase tracking-wider">
              Top Destinations
            </h4>
            <ul className="space-y-2 sm:space-y-2.5 text-sm font-light">
              ...
              <li><Link to="/destinations" className="text-[#d7007f] hover:text-[#f7a600] transition-colors inline-flex items-center gap-1 py-1">
